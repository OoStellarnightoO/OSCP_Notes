## Generic CSharp Meterpreter RevShell Staged Payload in Memory

reflect the buf var with the generated shellcode

Also when compiling make sure to select the x64 arch. This compiles as an exe

Probably won't evade any AVs.
